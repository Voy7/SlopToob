...
export default new class Logger {
  public info(message: any, ...args: any[]) { // Informational messages
    this.send(message, 'INFO'.cyan, ...args)
  }
  public warn(message: any, ...args: any[]) { // Warning messages
    this.send(message, 'WARN'.yellow, ...args)
  }
  public error(message: any, ...args: any[]) { // Error messages
