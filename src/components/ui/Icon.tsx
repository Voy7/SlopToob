const icons = {
  ...
  fullscreen: (
    <svg viewBox="0 0 24 24">
      <path
        fill="currentColor"
        d="M5 19v-5h2v3h3v2H5Zm0-9V5h5v2H7v3H5Zm9 9v-2h3v-3h2v5h-5Zm3-9V7h-3V5h5v5h-2Z"
      ></path>
    </svg>
  ),
  play: (
  ...
  previous: (
    <svg viewBox="0 0 24 24">
      <path
        fill="currentColor"
        d="M6.5 18q-.425 0-.713-.288T5.5 17V7q0-.425.288-.713T6.5 6q.425 0 .713.288T7.5 7v10q0 .425-.288.713T6.5 18Zm10.45-1.025l-6.2-4.15q-.45-.3-.45-.825t.45-.825l6.2-4.15q.5-.325 1.025-.037t.525.887v8.25q0 .6-.525.9t-1.025-.05Z"
      ></path>
    </svg>
  ),
  volume: (
  ...
  send: (
    <svg viewBox="0 0 24 24">
      <path
        fill="currentColor"
        d="m19.8 12.925l-15.4 6.5q-.5.2-.95-.088T3 18.5v-13q0-.55.45-.838t.95-.087l15.4 6.5q.625.275.625.925t-.625.925ZM5 17l11.85-5L5 7v3.5l6 1.5l-6 1.5V17Zm0 0V7v10Z"
      ></path>
    </svg>
  ),
  folder: (
  ...
  'folder-open': (
    <svg viewBox="0 0 24 24">
      <path
        fill="currentColor"
        d="M22 8H7.85q-1.55 0-2.7.975T4 11.45V18l1.975-6.575q.2-.65.738-1.038T7.9 10h12.9q1.025 0 1.613.813t.312 1.762l-1.8 6q-.2.65-.738 1.038T19 20H4q-.825 0-1.413-.588T2 18V6q0-.825.588-1.413T4 4h5.175q.4 0 .763.15t.637.425L12 6h8q.825 0 1.413.588T22 8Z"
      ></path>
    </svg>
  ),
  'video-file': (
